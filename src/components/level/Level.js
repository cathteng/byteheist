...
class Level {
    ...
    _levelZero() {
        ...
        // middle platforms
        const middlePlatforms = [new CANNON.Vec3(0, 0, 50), new CANNON.Vec3(0, 0, 100), new CANNON.Vec3(0, 0, 150), new CANNON.Vec3(0, 0, 200)];
        const platformColor = '#006F27';

        for (const p of middlePlatforms) {
            ({groundMesh, groundBody} = INIT.initGround(start_width, start_height, start_depth, p, platformColor));
            groundMeshes.push(groundMesh);
            groundBodies.push(groundBody);
        }
        ...
        // resistors
        const resistorPositions = [new THREE.Vector3(15, 0, 100), new THREE.Vector3(0, 0, 100), new THREE.Vector3(-15, 0, 100), new THREE.Vector3(-30, 0, 100), new THREE.Vector3(30, 0, 100)];
        ...
        // capacitor
        const capacitorPositions = [new THREE.Vector3(0, 2.5, 150), new THREE.Vector3(-30, 2.5, 150), new THREE.Vector3(30, 2.5, 150)];
        ...
        // copper
        const copperPositions = [new THREE.Vector3(-20, 0.5, 210), new THREE.Vector3(-20, 0.5, 205), new THREE.Vector3(20, 0.5, 210), new THREE.Vector3(20, 0.5, 205), new THREE.Vector3(-20, 0.5, 200), new THREE.Vector3(-20, 0.5, 195), new THREE.Vector3(20, 0.5, 200), new THREE.Vector3(20, 0.5, 195)];
    ...
    _levelOne() {
        ...
        resistorPositions.push([new THREE.Vector3(10, 0, 75), 2], [new THREE.Vector3(-40, 0, 75), 1]);
        ...
        capacitorPositions.push(new THREE.Vector3(-25, 2.5, 110), new THREE.Vector3(0, 2.5, 125), new THREE.Vector3(25, 2.5, 140));
        ...
        resistorPositions.push([new THREE.Vector3(10, 0, 165), 3], [new THREE.Vector3(20, 0, 165), 3], [new THREE.Vector3(30, 0, 165), 3], [new THREE.Vector3(40, 0, 165), 3]);
        ...
        copperPositions.push([new THREE.Vector3(-20, 0.5, 210), 2, 20, 1], [new THREE.Vector3(-20, 0.5, 220), 2, 20, 1], [new THREE.Vector3(20, 0.5, 210), 2, 20, 1], [new THREE.Vector3(20, 0.5, 220), 2, 20, 1], [new THREE.Vector3(-20, 0.5, 230), 2, 20, 1], [new THREE.Vector3(-20, 0.5, 240), 2, 20, 1], [new THREE.Vector3(20, 0.5, 230), 2, 20, 1], [new THREE.Vector3(20, 0.5, 240), 2, 20, 1]);
        ...
        resistorPositions.push([new THREE.Vector3(-45, 0, 275), 3], [new THREE.Vector3(-22.5, 0, 275), 3], [new THREE.Vector3(0, 0, 275), 3], [new THREE.Vector3(22.5, 0, 275), 3], [new THREE.Vector3(45, 0, 275), 3]);
        ...
        capacitorPositions.push(new THREE.Vector3(-10, 2.5, 325), new THREE.Vector3(10, 2.5, 325), new THREE.Vector3(0, 2.5, 315), new THREE.Vector3(0, 2.5, 335));
        ...
        copperPositions.push([new THREE.Vector3(0, 0.5, 375), 50, 2, 1], [new THREE.Vector3(-40, 0.5, 375), 50, 2, 1], [new THREE.Vector3(41, 0.5, 375), 50, 2, 1]);
        ...
        capacitorPositions.push(new THREE.Vector3(30, 2.5, 410), new THREE.Vector3(20, 2.5, 420), new THREE.Vector3(10, 2.5, 430), new THREE.Vector3(0, 2.5, 440), new THREE.Vector3(-10, 2.5, 430), new THREE.Vector3(-20, 2.5, 420), new THREE.Vector3(-30, 2.5, 410));
    ...
    _levelTwo() {
        ...
        // resistor
        resistorPositions.push([new THREE.Vector3(15, 0, 160), 1], [new THREE.Vector3(-15, 0, 160), 1], [new THREE.Vector3(15, 0, 100), 1], [new THREE.Vector3(-15, 0, 100), 1], [new THREE.Vector3(15, 0, 40), 1], [new THREE.Vector3(-15, 0, 40), 1]);

        //
        resistorPositions.push([new THREE.Vector3(-45, 0, 190), 2], [new THREE.Vector3(-45, 0, 220), 2], [new THREE.Vector3(-105, 0, 190), 2], [new THREE.Vector3(-105, 0, 220), 2], [new THREE.Vector3(-165, 0, 190), 2], [new THREE.Vector3(-165, 0, 220), 2], [new THREE.Vector3(45, 0, 190), 2], [new THREE.Vector3(45, 0, 220), 2], [new THREE.Vector3(105, 0, 190), 2], [new THREE.Vector3(105, 0, 220), 2], [new THREE.Vector3(165, 0, 190), 2], [new THREE.Vector3(165, 0, 220), 2]);
        ...
        // capacitor
        capacitorPositions.push(new THREE.Vector3(0, 2.5, 130), new THREE.Vector3(0, 2.5, 70), new THREE.Vector3(0, 2.5, -130), new THREE.Vector3(0, 2.5, -70));

        //
        capacitorPositions.push(new THREE.Vector3(135, 2.5, -205), new THREE.Vector3(75, 2.5, -205), new THREE.Vector3(135, 2.5, 205), new THREE.Vector3(75, 2.5, 205), new THREE.Vector3(-135, 2.5, -205), new THREE.Vector3(-75, 2.5, -205), new THREE.Vector3(-135, 2.5, 205), new THREE.Vector3(-75, 2.5, 205));

        //
        capacitorPositions.push(new THREE.Vector3(-160, 2.5, 15), new THREE.Vector3(-160, 2.5, -15), new THREE.Vector3(-100, 2.5, 15), new THREE.Vector3(-100, 2.5, -15), new THREE.Vector3(-40, 2.5, 15), new THREE.Vector3(-40, 2.5, -15));

        //
        capacitorPositions.push(new THREE.Vector3(160, 2.5, 15), new THREE.Vector3(160, 2.5, -15), new THREE.Vector3(100, 2.5, 15), new THREE.Vector3(100, 2.5, -15), new THREE.Vector3(40, 2.5, 15), new THREE.Vector3(40, 2.5, -15));

        //
        capacitorPositions.push(new THREE.Vector3(190, 2.5, 160), new THREE.Vector3(220, 2.5, 160), new THREE.Vector3(190, 2.5, 100), new THREE.Vector3(220, 2.5, 100), new THREE.Vector3(190, 2.5, 40), new THREE.Vector3(220, 2.5, 40));
        ...
        // copper
        copperPositions.push([new THREE.Vector3(40, 0.5, 0), 20, 1, 1], [new THREE.Vector3(100, 0.5, 0), 20, 1, 1], [new THREE.Vector3(160, 0.5, 0), 20, 1, 1], [new THREE.Vector3(-40, 0.5, 0), 20, 1, 1], [new THREE.Vector3(-100, 0.5, 0), 20, 1, 1], [new THREE.Vector3(-160, 0.5, 0), 20, 1, 1]);

        //
        copperPositions.push([new THREE.Vector3(205, 0.5, 40), 1, 20, 1], [new THREE.Vector3(205, 0.5, 100), 1, 20, 1], [new THREE.Vector3(205, 0.5, 160), 1, 20, 1], [new THREE.Vector3(205, 0.5, -40), 1, 20, 1], [new THREE.Vector3(205, 0.5, -100), 1, 20, 1], [new THREE.Vector3(205, 0.5, -160), 1, 20, 1]);
